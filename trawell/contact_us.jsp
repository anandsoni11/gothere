      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span6 offset3">
				...
				%>
				<h3>Reach us, the guys who founded Trawell Inc. to get you flying, with ease!</h3>
				<h4><a href="mailto:admins@trawell.in">Write to us!</a></h4>
				<h4>Official locations coming up soon!</h4>
				</div>
		</div>
		<br>
		<br>
