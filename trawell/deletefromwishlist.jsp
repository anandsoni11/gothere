    ...
    <div class="content">
      <div class="container">
        ...
        %>
          ...
          <h3>Delete places from your Wishlist</h3>
          <%
          team_trawell.trawell l = new team_trawell.trawell();
          l.createConnection();
          String countries=l.getCountries();
          String spt = l.selectWishlistSpots(myname);
          %>
          <form action="deleteconfirm.jsp" class="form-horizontal form-signin-signup">
          <select name="delete" id="1">
          <%
          StringTokenizer st = new StringTokenizer(spt, ",");
          ...
          <input type="submit" name="del" value="Delete Spot" class="btn btn-primary btn-large">
        </form>
