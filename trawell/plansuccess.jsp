    ...
    <div class="content">
      ...
      <div class="container">
        <div class="page-header">
         ...
         String pid = (String) session.getAttribute("pid1");
         int plid = Integer.parseInt(pid);
         Integer cid = (Integer) session.getAttribute("citid");
         int citid=(Integer)cid;
         String spot = request.getParameter("spotplan");
         String date = (String) session.getAttribute("newdate");
         System.out.println(user+ " "+pid+" "+spot+" "+date);
         System.out.println(cid);
         team_trawell.trawell l = new team_trawell.trawell();
         l.createConnection(); 
         l.insertinToVisit(user,plid,citid,spot,date);
                  
         %>
        <h2>Add Plan Place</h2>
        <h3>Plan Places added successfully!</h3>
        </div>
      </div>
    </div>
    <br>
